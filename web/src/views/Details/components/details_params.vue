<template>
      ...
      <div class="container">
        <div class="col-lg-12" style="width: 30vw">
          ...
          <div class="prod_options version_2">
            ...
            <el-divider />
            <div class="row">
              <label class="col-xl-7 col-lg-5 col-md-6 col-6" style="font-size: large"><strong>选项</strong> - 参数选择
              </label>
            ...
            <el-divider />
            <div class="row">
              <label class="col-xl-7 col-lg-5 col-md-6 col-6" style="font-size: large"><strong>选项</strong> - 类型选择
              </label>
              <div class="col-xl-5 col-lg-5 col-md-6 col-6" style="padding-bottom: 10px">
            ...
            <div class="row">
              <label class="col-xl-7 col-lg-5 col-md-6 col-6"
                style="width:40%; font-size: medium;"><strong>数量</strong></label>
            ...
            <div class="row mt-3">
              <div class="col-lg-7 col-md-6">
                <div class="price_main">
                  <span class="new_price">${{ price }}</span><span class="percentage">-20%</span>
  ...
  <!--参数选项表-->
  <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="size-modal" id="para-modal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">参数选择</h5>
  ...
  <GoodsIntroduce :dataWithPic="store.dataWithPic" />
</template>
